...
const BASE_URL = import.meta.env.VITE_API_BASE_URL || 'https://localhost:7167';
...
const API = {
  ...
  downloadSubmission: (id, forEdit) => request('GET', '/api/pwdtemplate/submissions/' + id + '/download' + (forEdit ? '?forEdit=true' : '')), // Blob
